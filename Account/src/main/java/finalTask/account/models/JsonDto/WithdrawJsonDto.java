...
public class WithdrawJsonDto {
    ...
    public WithdrawJsonDto(){

    }

    public WithdrawJsonDto(AccountJsonDto account, BigDecimal amount, String dateOfTransaction, HistoryOfTransactionsJsonDto historyOfTransactions) {
    ...
    public AccountJsonDto getAccountDto() {
        return account;
    }

    public void setAccountDto(AccountJsonDto account) {
        this.account = account;
    }
